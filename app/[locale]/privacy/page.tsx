...
const content: Record<Locale, PrivacyContent> = {
  ...
  th: {
    ...
    back: "กลับ",
    sections: [
      { heading: "1. ภาพรวมของบริการ", body: "Pixelyaki เป็นเครื่องมือสร้าง QR Code บนเบราว์เซอร์ ไม่จำเป็นต้องมีบัญชีหรือสมัครสมาชิก" },
      { heading: "2. ข้อมูลที่เก็บรวบรวม", body: "ข้อความ สี และไฟล์โลโก้ที่ป้อนเข้ามาจะไม่ถูกส่งหรือจัดเก็บบนเซิร์ฟเวอร์ใดๆ การประมวลผลทั้งหมดเกิดขึ้นในเบราว์เซอร์ของคุณ\n\nGoogle Analytics 4 (GA4) อาจเก็บรวบรวม:\n• ข้อมูลการเข้าชมหน้าเว็บ\n• ข้อมูลอุปกรณ์และเบราว์เซอร์\n• ที่อยู่ IP แบบไม่ระบุตัวตน" },
      { heading: "3. การจัดเก็บในเครื่อง", body: "โหมดมืด/สว่างจะเป็นไปตามการตั้งค่าระบบโดยอัตโนมัติ บริการไม่ได้จัดเก็บการตั้งค่าธีมแยกต่างหาก" },
      { heading: "4. บริการของบุคคลที่สาม", body: "บริการนี้ใช้ Google Analytics 4 ข้อมูลที่เก็บรวบรวมอยู่ภายใต้นโยบายความเป็นส่วนตัวของ Google\nhttps://policies.google.com/privacy" },
      { heading: "5. ความเป็นส่วนตัวของเด็ก", body: "บริการนี้ไม่เหมาะสำหรับเด็กอายุต่ำกว่า 14 ปี" },
      { heading: "6. การเปลี่ยนแปลงนโยบาย", body: "นโยบายนี้อาจได้รับการอัปเดตโดยไม่แจ้งล่วงหน้า" },
      { heading: "7. ติดต่อเรา", body: "สำหรับคำถามเกี่ยวกับความเป็นส่วนตัว: pixelyaki@gmail.com" }
    ]
  }
};
