...
const styleCopyByLocale: Record<Locale, StyleCopy> = {
  ...
  ja: {
    ...
    styleRounded: "ラウンド",
    styleClassy: "クラシー",
    styleClassyRounded: "クラシーラウンド",
    styleExtraRounded: "エキストララウンド",
    styleDot: "ドット",
    errorCorrectionLabel: "密度",
    eclL: "低", eclM: "中", eclQ: "高", eclH: "最高"
  },
  es: {
    ...
    styleExtraRounded: "Extra redondeado",
    styleDot: "Punto",
  ...
  de: {
    ...
    styleExtraRounded: "Extra abgerundet",
    styleDot: "Punkt",
  ...
  ru: {
    ...
    styleSquare: "Квадрат",
    styleDots: "Точки",
    styleRounded: "Закругленный",
    styleClassy: "Классический",
    styleClassyRounded: "Классический закругленный",
    styleExtraRounded: "Экстра закругленный",
    styleDot: "Точка",
  ...
  ar: {
    ...
    styleExtraRounded: "مستدير للغاية",
    styleDot: "نقطة",
  ...
  hi: {
    ...
    presetClassy: "क्लासी",
    presetDot: "डॉट",
    styleSquare: "वर्गाकार",
    styleDots: "बिंदु",
    styleRounded: "गोल",
    styleClassy: "क्लासिक",
    styleClassyRounded: "क्लासिक गोल",
  ...
  it: {
    ...
    styleClassy: "Classico",
    styleClassyRounded: "Classico arrotondato",
    styleExtraRounded: "Extra arrotondato",
    styleDot: "Punto",
  ...
  pt: {
    ...
    styleClassy: "Clássico",
    styleClassyRounded: "Clássico arredondado",
  ...
  th: {
    ...
    styleRounded: "โค้งมน",
    styleClassy: "คลาสสิก",
    styleClassyRounded: "คลาสสิกโค้งมน",
