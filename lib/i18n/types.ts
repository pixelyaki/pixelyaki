...
export type ExtraModeCopy = {
  ...
  mecardModeLabel: string;
  mecardNameLabel: string;
  mecardNamePlaceholder: string;
  mecardPhoneLabel: string;
  mecardPhonePlaceholder: string;
  mecardEmailLabel: string;
  mecardEmailPlaceholder: string;
  mecardAddressLabel: string;
  mecardAddressPlaceholder: string;
  mecardEmptyPreview: string;
  calendarModeLabel: string;
  calendarTitleLabel: string;
  calendarTitlePlaceholder: string;
  calendarStartLabel: string;
  calendarEndLabel: string;
  calendarLocationLabel: string;
  calendarLocationPlaceholder: string;
  calendarDescriptionLabel: string;
  calendarDescriptionPlaceholder: string;
  calendarEmptyPreview: string;
  paypalModeLabel: string;
  paypalEmailLabel: string;
  paypalEmailPlaceholder: string;
  paypalItemLabel: string;
  paypalItemPlaceholder: string;
  paypalAmountLabel: string;
  paypalAmountPlaceholder: string;
  paypalCurrencyLabel: string;
  paypalEmptyPreview: string;
  cryptoModeLabel: string;
  cryptoAddressLabel: string;
  cryptoAddressPlaceholder: string;
  cryptoAmountLabel: string;
  cryptoAmountPlaceholder: string;
  cryptoCoinLabel: string;
  cryptoLabelLabel: string;
  cryptoLabelPlaceholder: string;
  cryptoEmptyPreview: string;
};
